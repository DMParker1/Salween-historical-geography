...
- [`registers/maps.md`](registers/maps.md) — historical map register
- [`registers/sources.md`](registers/sources.md) — source and provenance register
- [`registers/hypotheses.md`](registers/hypotheses.md) — active research hypotheses
...
Historical claims should preserve the distinction between:
